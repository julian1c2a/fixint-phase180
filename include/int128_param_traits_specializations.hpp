...
// @brief      Traits en el namespace nstd:: para int128_param_t
...
// El #undef separa la ultima invocacion de la macro de lo que viene detras;
// sin esta linea en blanco doxygen intenta seguir leyendo una lista de
// inicializacion y avisa.
