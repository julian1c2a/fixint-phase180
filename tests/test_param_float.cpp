...
static void test_float_assignment()
{
    ...
    int128_tc_t tc{0};
    tc = 42.7f;   TEST("tc =  42.7f -> \"42\"",  tc.to_string() == "42");
    tc = -99.3f;  TEST("tc = -99.3f -> \"-99\"", tc.to_string() == "-99");

    int128_ms_t ms{0};
    ms = 100.9f;  TEST("ms =  100.9f -> \"100\"", ms.to_string() == "100");
    ms = -50.1f;  TEST("ms =  -50.1f -> \"-50\"", ms.to_string() == "-50");

    int128_ek_t ek{0};
    ek = 10.5f;   TEST("ek =  10.5f -> \"10\"",  ek.to_string() == "10");
    ek = -20.8f;  TEST("ek = -20.8f -> \"-20\"", ek.to_string() == "-20");
}
...
static void test_double_assignment()
{
    ...
    int128_tc_t tc{0};
    tc = 123.456;         TEST("tc =  123.456         -> \"123\"",          tc.to_string() == "123");
    tc = 1234567890123.0; TEST("tc =  1234567890123.0 -> \"1234567890123\"",tc.to_string() == "1234567890123");

    int128_ms_t ms{0};
    ms =  999.999;  TEST("ms =  999.999  -> \"999\"",  ms.to_string() == "999");
    ms = -777.777;  TEST("ms = -777.777  -> \"-777\"", ms.to_string() == "-777");

    int128_ek_t ek{0};
    ek =   50.0;  TEST("ek =  50.0  -> \"50\"",   ek.to_string() == "50");
    ek = -100.0;  TEST("ek = -100.0 -> \"-100\"", ek.to_string() == "-100");
}
...
static void test_long_double()
{
    ...
    // Assignment
    int128_tc_t tc{0}; tc = 987654321.123L; TEST("tc =  987654321.123L -> \"987654321\"", tc.to_string() == "987654321");
    int128_ms_t ms{0}; ms = 555555.555L;    TEST("ms =  555555.555L    -> \"555555\"",    ms.to_string() == "555555");
    int128_ek_t ek{0};
    ek =  300.0L; TEST("ek =  300.0L -> \"300\"",   ek.to_string() == "300");
    ek = -150.0L; TEST("ek = -150.0L -> \"-150\"",  ek.to_string() == "-150");
}
...
static void test_special_values()
{
    ...
    // NaN -> 0 (assignment)
    { int128_tc_t tc{42}; tc = nan_val; TEST("tc = NaN -> \"0\"", tc.to_string() == "0"); }
    { int128_ek_t ek{42}; ek = nan_val; TEST("ek = NaN -> \"0\"", ek.to_string() == "0"); }
...
static void test_ek_specific()
{
    ...
    TEST("ek ctor 0.0: high==bias, low==0",
         ek_zero.high() == (1ULL << 62) && ek_zero.low() == 0ULL);

    const int128_ek_t ek_one{1.0};
    TEST("ek ctor 1.0: high==bias, low==1",
         ek_one.high() == (1ULL << 62) && ek_one.low() == 1ULL);
...
static void test_truncation_and_chain()
{
    ...
    { int128_tc_t tc{100}; tc = 200.5; TEST("tc assign after ctor: 100 -> 200.5 -> \"200\"", tc.to_string() == "200"); }
    { int128_ms_t ms{-50}; ms = 75.9f; TEST("ms assign after ctor: -50 -> 75.9f -> \"75\"",  ms.to_string() == "75");  }
    { int128_ek_t ek{10};  ek = -20.0L; TEST("ek assign after ctor: 10 -> -20.0L -> \"-20\"", ek.to_string() == "-20"); }
}
