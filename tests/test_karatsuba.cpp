...
int main() {
    ...
    // Expected limbs: [1, 0, 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFFF]
    {
        ...
        const bool ok{k == s
            && k.limbs[0] == 1
            && k.limbs[1] == 0
            && k.limbs[2] == 0xFFFFFFFFFFFFFFFEull
    ...
    // Expected limbs: [0, 0, 1, 0]
    {
        ...
        const bool ok{k.limbs[0] == 0 && k.limbs[1] == 0
            && k.limbs[2] == 1 && k.limbs[3] == 0};
    ...
    // Case 4: small values: 3 * 7 = 21
    {
        ...
        const bool ok{k.limbs[0] == 21 && k.limbs[1] == 0
            && k.limbs[2] == 0 && k.limbs[3] == 0};
    ...
    // limbs: [1, 0xFFFFFFFFFFFFFFFE, 0, 0]
    {
        ...
        const bool ok{k.limbs[0] == 1
            && k.limbs[1] == 0xFFFFFFFFFFFFFFFEull
            && k.limbs[2] == 0 && k.limbs[3] == 0};
