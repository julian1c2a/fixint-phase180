...
| ~~`representation.hpp`~~ | ✅ **portado (22 sep 2026)**: MS y EK como `representation_form` de `fixed_int_t`, sin aritmética nueva — son codificaciones ([ADR-017](ADR-017-magnitud-signo-y-exceso-k-como-codificaciones.md)) y su comportamiento es indistinguible del de complemento a dos ([ADR-018](ADR-018-la-representacion-no-es-observable.md)) |
...
Van ocho de once. Las tres que cerró P1.5 --bits, cmath y numeric-- eran las
