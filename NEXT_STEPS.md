...
|---|---|
| **T6.7** — mapa de fusión de la documentación de raíz (11 ficheros, ~10.000 renglones). Aplazado por decisión del autor; hace falta decidir qué fichero es fuente de verdad de qué | este documento, Fase 6 |
